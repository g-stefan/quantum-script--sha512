...
#define QUANTUM_SCRIPT_EXTENSION_SHA512_LICENSE_HPP
...
namespace Quantum {
	namespace Script {
		namespace Extension {
			namespace SHA512 {
				namespace License {
					QUANTUM_SCRIPT_EXTENSION_SHA512_EXPORT const char *content();
					QUANTUM_SCRIPT_EXTENSION_SHA512_EXPORT const char *shortContent();
				};
			};
		};
	};
